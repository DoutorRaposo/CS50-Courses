...
-- I formatted online at SQLFormat.org, it was a mess before, but the code checks out:
...
-- Ruth says the thief got into a car and drove away within 10 minutes after the theft. Suggested looking at security footage from the bakery.
...
-- Too many suspects, have to narrow it down cross-referencing the list.
-- I corrected the syntax to join ALL the previous name lists and this is the result. Basically follow the order for joins and the conditionals after the joins:
...
-- Bruce stole the duck, called Robin, who helped him buying a ticket to New York. I'm sure he had a reason, maybe the duck was a target for the Joker?